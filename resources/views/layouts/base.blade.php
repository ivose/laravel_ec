                    ...
                    <div class="mid-section main-info-area">
                        ...
                        <div class="wrap-icon right-section">
                            ...
                            <div class="wrap-icon-section minicart">
                                <a href="{{ route('get.cart') }}" class="link-direction">
                                    <i class="fa fa-shopping-basket" aria-hidden="true"></i>
                                    <div class="left-info">
                                        @if($i = Cart::count())
                                        <span class="index">{{ $i }} {{$i == 1 ? 'item' : 'items'}}</span>
                                        @endif
                    ...
                    <div class="primary-nav-section">
                        <div class="container">
                            <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('get.shop') }}" class="link-term mercado-item-title">Shop</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('get.cart') }}" class="link-term mercado-item-title">Cart</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{route('get.checkout')}}" class="link-term mercado-item-title">Checkout</a>
                                </li>
                                <li class="menu-item">
