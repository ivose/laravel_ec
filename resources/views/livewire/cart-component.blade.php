                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-increase" href="#" wire:click.prevent="updateQuantity('{{ $item->rowId }}', 1)"></a>
                                <a class="btn btn-reduce" href="#" wire:click.prevent="updateQuantity('{{ $item->rowId }}', -1)"></a>
                            </div>
                        </div>
                        ...
                        <div class="delete">
                            <a href="#" class="btn btn-delete" title="Delete" wire:click.prevent="destroy('{{ $item->rowId }}', 0)">
